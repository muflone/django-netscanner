...
class DBRouter(object):
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        """
        if (obj1._meta.model_name == 'oui' or
                obj2._meta.model_name == 'oui'):
            return False
        return None
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        """
        if db == 'oui_db' and model_name == 'oui':
            return True
        elif db == 'default' and model_name != 'oui':
            return True
        return False
